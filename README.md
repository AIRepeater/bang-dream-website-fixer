# bang-dream-website-fixer
A Tampermonkey script that fixes broken images on BanG Dream official website by automatically replacing deprecated AWS S3 endpoints with functional ones.
修复BanG Dream官网图片加载问题的油猴脚本，自动将失效的AWS S3端点（s3-ap-northeast-1.amazonaws.com）替换为有效端点（s3.ap-northeast-1.amazonaws.com）。
